...
public class ProcessModel implements Cloneable
{
	...
	private List<ProcessLogModel> logList;
	...
	public List<ProcessLogModel> getLogList()
	{
		return logList;
	}
	public void setLogList(List<ProcessLogModel> logList)
	{
