...
{
	private Hashtable<String,BaseFieldBean> m_BaseFieldHashtable;

	public void setM_BaseFieldHashtable(Hashtable<String,BaseFieldBean> m_BaseFieldHashtable) {
		this.m_BaseFieldHashtable = m_BaseFieldHashtable;
	}

	public Hashtable<String,BaseFieldBean> getM_BaseFieldHashtable() {
	...
	//private int BaseIsAllowLogGroup=0;
