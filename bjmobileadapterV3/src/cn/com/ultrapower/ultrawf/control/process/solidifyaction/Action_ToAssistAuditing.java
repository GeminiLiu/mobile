...
public class Action_ToAssistAuditing extends Action_Base {

	protected String m_strError;
	
	public Action_ToAssistAuditing()
	{
		this.m_Action = "组织会审";
	...
	public boolean do_Action(
			...
			List<BaseToDealObject> 		p_BaseToAssistAuditingObject,
			...
			List<BaseAttachmentInfo> 	p_BaseAttachmentList)
	{
		...
		//插入会审记录
		if (push_WaitingAuditingProcess(p_BaseToAssistAuditingObject)==false)
		{
			BaseWrite_Log.writeLog(m_Action,1,"插入会审记录");
			baseClose();
			return false;	
		}		
