...
public class Action_Next extends Action_Base {
			...
			List<BaseAttachmentInfo> p_BaseAttachmentList)
	{
		...
		setFieldValueFromOtherField("Tmp_BaseCategoryCurrentPageName", "tmp_Pro_ActionPageName");
		setFieldValueFromOtherField("Tmp_BaseCategoryCurrentPageID", "tmp_Pro_ActionPageID");
		setFieldValueFromOtherField("tmp_BaseActionBtn_Fix_Char", "tmp_Pro_ActionName");
		//动作的个性化操作结束
