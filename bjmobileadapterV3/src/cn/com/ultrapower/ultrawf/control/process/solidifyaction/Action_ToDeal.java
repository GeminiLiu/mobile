...
public class Action_ToDeal extends Action_Base {

	protected String m_strError;
	
	public Action_ToDeal()
	{
		this.m_Action = "派发";
	...
	public boolean do_Action(
			...
			List<BaseToDealObject> 		p_BaseToDealObject,
			...
			List<BaseAttachmentInfo> 	p_BaseAttachmentList)
	{
		...
		//插入派发记录
		if (push_WaitingDealProcess(p_BaseToDealObject)==false)
		{
			BaseWrite_Log.writeLog(m_Action,1,"插入处理信息");
			baseClose();	
			return false;	
		}		
