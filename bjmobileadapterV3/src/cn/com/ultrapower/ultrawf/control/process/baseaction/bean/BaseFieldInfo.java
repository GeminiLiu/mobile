package cn.com.ultrapower.ultrawf.control.process.baseaction.bean;

import cn.com.ultrapower.system.remedyop.RemedyFieldInfo;

public class BaseFieldInfo extends RemedyFieldInfo {
	private String 		strFieldName;
	private String 		strFieldID;
	private String 		strFieldValue;
	private int 		intFieldType;
	private int 		intIsBaseOwnField;			//1 表示是，0表示不是
