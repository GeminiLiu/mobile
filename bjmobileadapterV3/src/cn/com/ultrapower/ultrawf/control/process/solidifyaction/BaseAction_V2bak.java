...
//import cn.com.ultrapower.ultrawf.share.remedyop.PublicFieldInfo;
//import cn.com.ultrapower.ultrawf.share.ConstantsManager;
...
public class BaseAction_V2bak
{
	
//	Hashtable Hashtable_BaseAllFields 		= null;
//
//	/**
//	 * 工单动作：新建工单函数
...
//			ownCount=List_BaseOwnFieldInfoGet.size();
//		
//		Hashtable Hashtable_BaseOwnAllFields = new Hashtable();
//		
...
//		int rowCount=0;
//		if(List_BaseOwnFieldInfoGet!=null)
//			rowCount=List_BaseOwnFieldInfoGet.size();
...
//		//操作工单信息初始化
//
//		if (this.Init_Open_Base(p_BaseSchema,p_BaseID,p_OperateUserLoginName,1,"自动质检")==false)
//		{   
//			Init_BaseWrite_Log("自动质检",1,"“自动质检”初始化失败！");
//			return false;	
//		}	
//
////		确认时显示或编辑的字段初始化
...
//			else
//			{
//				Init_BaseWrite_Log("自动质检",1,p_obj_BaseFieldInfo.getStrFieldName()+"自动质检，“确认抄送”时不可填写！");
//				return false;
//			}
//		}
//		Hashtable_BaseOwnAllFields.clear();
...
//
//
//		if(!this.Init_BaseActionBtn("未质检自动流转",null,true)){
//			Init_BaseWrite_Log("确认",1,"BaseActiveBtn赋值“确认”失败！");
//			return false;			
//		}
//		
...
//			this.Hashtable_BaseAllFields = new Hashtable();
//			
	//		初始化字段信息
...
//				
//				Hashtable Hashtable_AddBaseAttachAllFields = new Hashtable();
//				
...
//				int listCount=0;
//				if(m_ConfigUserCloseBaseGroupModelList!=null)
//					listCount=m_ConfigUserCloseBaseGroupModelList.size();
//				if (listCount>0)
//				{
...
//					BaseFieldInfo m_BaseFieldInfo_tmp_Pro_FlagPredefined = null;
//					m_BaseFieldInfo_tmp_Pro_FlagPredefined = (BaseFieldInfo)Hashtable_BaseAllFields.get("tmp_Pro_FlagPredefined");
//					Integer m_tmp_Pro_FlagPredefined_int = new Integer(m_DealProcessModel.getFlagPredefined());
//					m_BaseFieldInfo_tmp_Pro_FlagPredefined.setStrFieldValue(m_tmp_Pro_FlagPredefined_int.toString());
//					
//					BaseFieldInfo m_BaseFieldInfo_tmp_Pro_FlagDuplicated = null;
//					m_BaseFieldInfo_tmp_Pro_FlagDuplicated = (BaseFieldInfo)Hashtable_BaseAllFields.get("tmp_Pro_FlagDuplicated");
//					Integer m_tmp_Pro_FlagDuplicated_int = new Integer(m_DealProcessModel.getFlagDuplicated());
//					m_BaseFieldInfo_tmp_Pro_FlagDuplicated.setStrFieldValue(m_tmp_Pro_FlagDuplicated_int.toString());
//			
//					BaseFieldInfo m_BaseFieldInfo_tmp_Pro_FlagActive = null;
//					m_BaseFieldInfo_tmp_Pro_FlagActive = (BaseFieldInfo)Hashtable_BaseAllFields.get("tmp_Pro_FlagActive");
//					Integer m_tmp_Pro_FlagActive_int = new Integer(m_DealProcessModel.getFlagActive());
...
//					BaseFieldInfo m_BaseFieldInfo_tmp_Pro_FlagPredefined = null;
//					m_BaseFieldInfo_tmp_Pro_FlagPredefined = (BaseFieldInfo)Hashtable_BaseAllFields.get("tmp_Pro_FlagPredefined");
//					Integer m_tmp_Pro_FlagPredefined_int = new Integer(m_AuditingProcessModel.getFlagPredefined());
//					m_BaseFieldInfo_tmp_Pro_FlagPredefined.setStrFieldValue(m_tmp_Pro_FlagPredefined_int.toString());
//					
//					BaseFieldInfo m_BaseFieldInfo_tmp_Pro_FlagDuplicated = null;
//					m_BaseFieldInfo_tmp_Pro_FlagDuplicated = (BaseFieldInfo)Hashtable_BaseAllFields.get("tmp_Pro_FlagDuplicated");
//					Integer m_tmp_Pro_FlagDuplicated_int = new Integer(m_AuditingProcessModel.getFlagDuplicated());
//					m_BaseFieldInfo_tmp_Pro_FlagDuplicated.setStrFieldValue(m_tmp_Pro_FlagDuplicated_int.toString());
//		
//					BaseFieldInfo m_BaseFieldInfo_tmp_Pro_FlagActive = null;
//					m_BaseFieldInfo_tmp_Pro_FlagActive = (BaseFieldInfo)Hashtable_BaseAllFields.get("tmp_Pro_FlagActive");
//					Integer m_tmp_Pro_FlagActive_int = new Integer(m_AuditingProcessModel.getFlagActive());
//					m_BaseFieldInfo_tmp_Pro_FlagActive.setStrFieldValue(m_tmp_Pro_FlagActive_int.toString());
//	
//					BaseFieldInfo m_BaseFieldInfo_tmp_Pro_Flag15ToAuditing = null;
//					m_BaseFieldInfo_tmp_Pro_Flag15ToAuditing = (BaseFieldInfo)Hashtable_BaseAllFields.get("tmp_Pro_Flag15ToAuditing");
...
//		{
//			int listCount=0;
//			if(p_BaseToDealObject!=null)
//				listCount=p_BaseToDealObject.size();
//			for (int i = 0;i<listCount;i++)
//			{
//
//				BaseToDealObject m_tmp_BaseToDealObject = (BaseToDealObject)p_BaseToDealObject.get(i);
//				
//				Hashtable Hashtable_ToDealProcessAllFields = new Hashtable();
//				
...
//		int listCount=0;
//		if(p_BaseDealObject!=null)
//			listCount=p_BaseDealObject.size();
//		
//		for (int i = 0 ; i < listCount; i++)
//		{
...
//						dealCount=DealProcessList.size();
...
//					{
//						DealProcessModel m_DealProcessModel = (DealProcessModel) DealProcessList.get(i);
//						if (m_DealProcessModel.getFlagType() == 0)//主办
//						{
...
//
//			//		UltraProcess:App_BaseAttachment：		当前工单的附件记录
//
//			//		UltraProcess:App_Base_Infor：			当前工单的所有工单记录
//
...
//		
//		Hashtable_BaseAllFields = new Hashtable();
//		if (p_Operation == 1)
//		{		
...
//		
//		//if(BaseActionOp.Action_Start("liuliwei","UltraProcess:App_Base","000000000000020",new ArrayList()))
//		
//		if(BaseActionOp.Action_Finish("liuliwei","UltraProcess:App_Base","000000000000020","完成描述",new ArrayList(),new ArrayList()))
//		{
...
////		BaseFieldInfo m_BaseAcceptOutTime = new BaseFieldInfo("BaseAcceptOutTime","700000017","11111",7); 
////		BaseNewFields.add(m_BaseAcceptOutTime);		
////		BaseFieldInfo m_BaseDealOutTime = new BaseFieldInfo("BaseDealOutTime","700000018","22222",7); 
...
////
////	   String BaseId = BaseActionOp.Action_New("Demo","UltraProcess:App_Base",BaseNewFields,new ArrayList());
////	   if (BaseId==null)
////		{
...
////			baseToDealObject.setAssgineeID("huangwei");
...
////			baseToDealObject.setAssgineeID("lizhuang");
////			baseToDealObject.setGroup("");
////			baseToDealObject.setGroupID("");
////			baseToDealObject.setAssignOverTimeDate(FormatTime.FormatStringToDate("2006-11-25 11:00:17"));
////			baseToDealObject.setDealOverTimeDate(FormatTime.FormatStringToDate("2006-11-25 11:00:17"));
...
////			p_BaseToDealObject.add(baseToDealObject);
//			
////			if(BaseActionOp.Action_ToDeal("Demo","UltraProcess:App_Base",BaseId,"派发描述",p_BaseToDealObject,new ArrayList()))
//			
////			{	
...
//
////
////				if(BaseActionOp.Action_Confirm("lizhuang","UltraProcess:App_Base",BaseId,"确认抄送描述",new ArrayList(),new ArrayList())){
...
////				
////				if(BaseActionOp.Action_DealTurnUp("huangwei","UltraProcess:App_Base",BaseId,"驳回描述",p_BaseDealObject,new ArrayList())){
...
////						baseDealObject.setAssgineeID("huangwei");
////						baseDealObject.setGroup("");
////						baseDealObject.setGroupID("");
////					
////						p_BaseDealObjectcb.add(baseDealObject);
////						if(BaseActionOp.Action_DealHasten("Demo","UltraProcess:App_Base",BaseId,"催办描述",p_BaseDealObjectcb,new ArrayList())){
...
////						//受理,阶段回复,完成
////						
////						if(BaseActionOp.Action_Start("huangwei","UltraProcess:App_Base",BaseId,new ArrayList()))
////						{
////							System.out.println("受理成功！\n");					
////							
////							if(BaseActionOp.Action_PhaseNotice("huangwei","UltraProcess:App_Base",BaseId,"阶段回复描述",new ArrayList(),new ArrayList())){
////								System.out.println("阶段回复成功！\n");	
////								if(BaseActionOp.Action_Finish("huangwei","UltraProcess:App_Base",BaseId,"完成描述",new ArrayList(),new ArrayList())){
...
////									if(BaseActionOp.Action_DealTurnDown("Demo","UltraProcess:App_Base",BaseId,"退回描述",p_BaseDealObjectth,new ArrayList())){
////										System.out.println("退回成功！\n");	
////										if(BaseActionOp.Action_Finish("huangwei","UltraProcess:App_Base",BaseId,"完成描述1",new ArrayList(),new ArrayList())
////												){
////											System.out.println("完成成功！\n");	
//////											if(BaseActionOp.Action_Close("Demo","UltraProcess:App_Base",BaseId,"关闭描述",new ArrayList())){
//////												System.out.println("关闭成功！\n");													
//////											}else{
//////												System.out.println("关闭失败！\n");
//////											}
////											if(BaseActionOp.Action_Cancel("Demo","UltraProcess:App_Base",BaseId,"作废描述",new ArrayList())){
...
////				baseDealObject.setAssgineeID("lizhuang");
////				baseDealObject.setGroup("");
////				baseDealObject.setGroupID("");
////			
////				p_BaseDealObject.add(baseDealObject);
////				if(BaseActionOp.Action_DealRecall("Demo","UltraProcess:App_Base",BaseId,"追回描述",0,p_BaseDealObject,new ArrayList())){
...
////		p_BaseToDealObject.add(baseToDealObject);
////		
////	   if(BaseActionOp.Action_ToDeal_FormGivenUser("xufaqiu","000000000004097","DEAL","UltraProcess:App_Base","000000000001164","转派描述",p_BaseToDealObject,new ArrayList())) 
////		{	
