...
public class SourceConfigAction_new extends HttpServlet {

	static final Logger logger = (Logger) Logger.getLogger(SourceConfigAction_new.class);
...
//			}
		...
		//				System.out.println("source_id::::::::::::::"+source_id);
					...
					response.sendRedirect(Path+"/roles/sourceconfig_new.jsp?targetflag=yes");
				...
				{	
					...
					logger.info("修改成功！");
					String Path = request.getContextPath();
					response.sendRedirect(Path+"/roles/sourceconfig_new.jsp?targetflag=yes2&flagType=2&id="+source_id);
				}
