...
public class RolesManageRequestAction  extends HttpServlet 
{
		...
		throws ServletException, IOException 
	{
		...
		flag = rolesManage.rolesManageInsert(rolesManageInfo);
		
		if (flag) 
		{

			String contextPath = req.getContextPath();
			res.sendRedirect(contextPath+"/roles/rolesmanageadd.jsp?targetflag=yes");
