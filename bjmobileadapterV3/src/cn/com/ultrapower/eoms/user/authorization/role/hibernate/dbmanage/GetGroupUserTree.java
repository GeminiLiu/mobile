...
public class GetGroupUserTree {

	static final Logger logger = (Logger) Logger.getLogger(GetGroupUserTree.class);
			    ...
			    for(Iterator it=list.iterator(); it.hasNext();)
		 	    {
		 	    	...
		 	    	//						��ǰID       ��ID             ��ʾ��              		   URL
		 	    	tmpstrjstree="d.add("+groupID+","+groupParentID+",\"<font onclick=back_time('"+groupName+"','','"+groupID+"');>"+groupName+"</font>\",\"\",\"\",\"main\",\"\",\"\",\"false\");";
		 	    	System.out.println(tmpstrjstree);
		 	    	
		 	    	strjstree=strjstree+tmpstrjstree+GetRoleGroupUserTree.findGroupUser(groupID);
		 	    }
			}
