...
import cn.com.ultrapower.eoms.user.rolemanage.people.hibernate.po.SysPeoplepo;
	...
	public class SendScopeGroupTree {

		static final Logger logger = (Logger) Logger.getLogger(SendScopeGroupTree.class);
				    ...
				    for(Iterator it=list.iterator(); it.hasNext();)
			 	    {
			 	    	...
			 	    	// ��ǰID ��ID ��ʾ�� URL
			 	    	tmpstrjstree="d.add("+groupID+","+groupParentID+",\"<font onclick=back_time('"+groupName+"','1','"+groupID+"');>"+groupName+"</font>\",\"\",\"\",\"main\",\"\",\"\",\"false\");";
