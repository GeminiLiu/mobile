package cn.com.ultrapower.eoms.user.authorization.sendscope.hibernate.dbmanage;
	...
	import cn.com.ultrapower.eoms.user.comm.function.Function;
		...
		public class SendScopeCheckedUserTree {
				static final Logger logger = (Logger) Logger.getLogger(SendScopeCheckedUserTree.class);
						    ...
						    while(it.hasNext())
					 	    {
						    	SysGrouppo sysgroup = (SysGrouppo)it.next();
					 	    	...
					 	    	//if(Group_Type==Group_Type1||Group_Type.equals(Group_Type1)){
						 	    	tmpstrjstree="d.add("+groupID+","+groupParentID+",\""+Group_Name+"</font>\",\"\",\"\",\"main\",\"\",\"\",\"false\");";
						 	    	
						 	    	strjstree=strjstree+tmpstrjstree+GetSendScopeUserTree.findGroupUser(groupID);
					 	    //	}
//					 	    	tmpstrjstree="d.add("+groupID+","+groupParentID+",\""+Group_Name+"<input type='checkbox' name='Group_Name' value='"+Group_Name+"'>"+
		 	    					//"</font>\",\"\",\"\",\"main\",\"\",\"\",\"false\");";
