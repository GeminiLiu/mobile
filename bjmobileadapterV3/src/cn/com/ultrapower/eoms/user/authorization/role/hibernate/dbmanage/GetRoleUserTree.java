...
import cn.com.ultrapower.eoms.user.rolemanage.people.hibernate.po.SysPeoplepo;
	...
	public class GetRoleUserTree 
	{
		static final Logger logger = (Logger) Logger.getLogger(GetRoleUserTree.class);
...
//				HibernateSessionFactory.closeSession();
			...
			{
				logger.info("238 GetRoleUserTree 类中 findGroupUser(String groupid) 方法执行查询时出现异常！");
				return null;
			}
		}
...
//				HibernateSessionFactory.closeSession();
			...
			{
				logger.info("239  GetRoleUserTree 类中 findUser(String userid,String groupid) 方法执行查询时出现异常！");
				return null;
			}
		}
