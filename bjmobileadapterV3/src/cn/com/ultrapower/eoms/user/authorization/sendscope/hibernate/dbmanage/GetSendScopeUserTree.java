...
public class GetSendScopeUserTree 
{

	static final Logger logger = (Logger) Logger.getLogger(GetSendScopeUserTree.class);
...
//			HibernateSessionFactory.closeSession();
		...
		{
			logger.info("276 GetSendScopeUserTree 类中 findUser(String userid,String groupid)  方法执行查询时出现异常！"+e.getMessage());
			return null;
		}
	}
