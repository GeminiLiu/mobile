...
public class UserAssociate {
    ...
    public static ArrayList associateInsert(PeopleInfo peopleInfo)
    {
		...
		try
		{
			...
			temp_User_GroupList		   = Function.nullString(temp_User_GroupList)+"1;";
		...
		{
			logger.error("[442]UserAssociate.associateInsert() Remedy系统用户信息添加时字段信息转换ArrayList对象失败"+e.getMessage());
			return null;
		}
	}
