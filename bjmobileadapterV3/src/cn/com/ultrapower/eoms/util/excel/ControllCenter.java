...
public class ControllCenter {
	 ...
	 * @return
	 */
	public static Content executeImortExcel_poi(HttpServletRequest request,HttpServletResponse response){
		return ImportExcel.execute(ImportExcel.getInputStream(request),response);
	}
	
	public static Content executeImortExcel(HttpServletRequest request,HttpServletResponse response){
		return ImportExcel.executeJxl(ImportExcel.getInputStream(request),response);
	}
	/**
	 * @param args
	 */
