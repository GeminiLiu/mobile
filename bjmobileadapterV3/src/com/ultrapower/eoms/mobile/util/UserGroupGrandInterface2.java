...
public class UserGroupGrandInterface2 {
	 ...
	 * @return Document
	 */
	public Document getGroupUserDoc(String argusername, String sourcename,RoleInfoBean roleinfobean) 
	{
		Long sourceid = null;
		String userid = null;
		...
		returnDoc = getUserGroup(userid, String.valueOf(sourceid),roleinfobean);
	 ...
	 * @return Document
	 */
	public Document getUserGroup(String userid, String sourceid,RoleInfoBean roleinfobean) 
	{
		Document doc 	= null;
		...
		try 
		{
			...
			try
			{
				list 								= role.getAllUserGroupGrand1(userid, sourceid,roleinfobean);
			}
			catch(Exception e)
			{
				System.out.println("UserGroupGrandInterface.getUserGroup"+
			...
			if(list!=null)
			{
				System.out.println("关联查询后共有："+list.size()+"条记录！");
	...
	public void addGroupElemet(Document doc,String groupid)
	{
		...
		System.out.println("parentArray:"+parentArray[0]);
		...
		for(int i=0;i<parentArray.length;i++)
		{
			...
			System.out.println("parentid:"+groupparentid);
	...
	public static void main(String[] args) {
		UserGroupGrandInterface2 usergroupgrand = new UserGroupGrandInterface2();
//		RoleInfoBean roleinfobean = new RoleInfoBean();
		//roleinfobean.setSkill_Action("3,4,7");
		long start = System.currentTimeMillis();
		Document doc =usergroupgrand.getGroupUserDoc("gongdan","UltraProcess:App_Base",null);
