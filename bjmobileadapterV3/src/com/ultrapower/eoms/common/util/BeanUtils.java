...
public class BeanUtils extends org.apache.commons.beanutils.BeanUtils {
	 ...
	 */
	public static void copyProperties(Object dest, Object src, boolean override) {
		...
		if (override) {
			...
			for (Field field : fieldsList) {
				try {
					gMethod = sClass.getMethod(getGetterName(field.getType(),
							field.getName()), null);
					sMethod = dClass.getMethod("set"
							+ StringUtils.capitalize(field.getName()), field
							.getType());
				} catch (NoSuchMethodException e) {
					// e.printStackTrace();
