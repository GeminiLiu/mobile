...
//    public final static String HIDDEN_PAGES_SIZE = "var_pagesize";
    public final static String HIDDEN_PAGES_SIZE = "pageSize";
	...
	public final static String HIDDEN_SORTFIELD="var_sortfield";//是否翻页提交
	public final static String HIDDEN_SORTTYPE="var_sorttype";//是否翻页提交
