...
public class Select {
	 ...
	 */
	public Select(String name,String style,String childrenname,String dataDicTypeCode,String onChangeFun,String value,HashMap customData,String customSql,String isnull,String childrenUrl){
		this.name = name;
	...
	public String getSelect(HttpServletRequest request){
		...
		if(customData!=null){//自定义下拉框数据值
			...
			List<DicItem> dicItsmList = dicManagerService.getRootItsmByDicType(dataDicTypeCode);
