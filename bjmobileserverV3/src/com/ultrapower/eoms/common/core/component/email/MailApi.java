...
public class MailApi {
	 ...
	 */
	private void getMailMsg(Session session, MimeMessage msg) throws IOException,
			MessagingException {
		...
		if (emailBean.getMsgContent() != null
				&& !emailBean.getMsgContent().equals(""))
			mBodyContent.setContent(emailBean.getMsgContent(), emailBean
	...
	public int sendMail() throws IOException, MessagingException {
		...
		try {
			getMailMsg(session, msg);
			trans = session.getTransport("smtp");
			try {
				trans.connect(EmailPara.MAIL_SMTP_HOST, EmailPara.MAIL_USER,
						EmailPara.MAIL_PASSWORD);
...
//			}
	...
	public static void main(String[] argv) throws Exception{
		...
		to.add("sunhailong@ultrapower.com.cn");
...
//		emailPara.debug = false;
//		emailPara.smtpHost = "pop3.163.com";
//		emailPara.mailUser = "zzh_640@163.com";
//		emailPara.mailPassword = "13401162542";
