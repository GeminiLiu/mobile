 ...
 * 摘要:
 */
public class UserManageOrganizationTreeImpl implements DynamicDataService {
	...
	public List<DtreeBean> getChildList(String parentid) {
		...
		if(orgList!=null && orgList.size()>0){
			for(DutyOrganization org : orgList){
				...
				dtreeBean.setId(DutyConstants.DUTY_MANAGE_CLASS_NAME+","+org.getPid());
				dtreeBean.setText(org.getOrganizationname());
				HashMap map = new HashMap();
				map.put("url",DutyConstants.ORGANIZATION_INFO_URL+org.getPid());
