  ...
  <head>
	...
	<body style="font-size:10px;padding:0px; margin:0px; background-color:#000000;">
		<div id="full" class="divfull">
		  	<dg:datagrid  items="${workSheets}" var="ws">
		  		<dg:condition>
					    ...
					    <table width="100%" border="0" cellspacing="0" cellpadding="0">
					      <tr>
					        <td width="100%">
					            <table width="100%" border="0" cellspacing="0" cellpadding="0">
					              <tr>
					                <td class="worksheetLeftNum" onclick="openDealedSheet('${ws.baseId}', '${ws.baseSchema}', '${ws.tplId}', '${ws.taskId}', '', '', '', '${itSysName}')">${rowindex}：</td>
					                <td class="worksheetFieldTd" onclick="openDealedSheet('${ws.baseId}', '${ws.baseSchema}', '${ws.tplId}', '${ws.taskId}', '', '', '', '${itSysName}')">工单号：${ws.baseSn}&nbsp;&nbsp;<font style="font-style:italic;text-decoration: underline;">(${ws.baseStatus})</font></td>
					              ...
					              <tr onclick="openDealedSheet('${ws.baseId}', '${ws.baseSchema}', '${ws.tplId}', '${ws.taskId}', '', '', '', '${itSysName}')">
					                <td class="worksheetLeftNum">　</td>
					                <td class="worksheetFieldTd">处理时间：<eoms:date value="${ws.assigneTime}"/></td>
					                <td class="worksheetLeftNum">　</td>
					              </tr>
					              <tr onclick="openDealedSheet('${ws.baseId}', '${ws.baseSchema}', '${ws.tplId}', '${ws.taskId}', '', '', '', '${itSysName}')">
					                <td class="worksheetLeftNum">　</td>
					      ...
					      <tr id="worksheetmore${rowindex}" style="display:none" onclick="openDealedSheet('${ws.baseId}', '${ws.baseSchema}', '${ws.tplId}', '${ws.taskId}', '', '', '', '${itSysName}')">
					        <td width="100%">
