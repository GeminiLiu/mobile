			...
			<form method="post" name="myform">
				<tr >
					<td width="43%" border="0">
						<c:choose>
					        	<c:when test="${multiple=='1'}">
					        		<select style="width:100%; height:381px;" name="left"  size="100" ondblclick="moveOption(document.getElementById('left'), document.getElementById('right'))">
					        	</c:when>
					        	<c:otherwise>
					        		<select style="width:100%; height:381px;" multiple name="left" size="100" ondblclick="moveOption(document.getElementById('left'), document.getElementById('right'))">
					        	</c:otherwise>
					   </c:choose>
					...
					<td width="43%" border="0">
						<c:choose>
					        	<c:when test="${multiple=='1'}">
					        		<select style="width:100%; height:381px;" name="right" size="100" ondblclick="delOption(document.getElementById('right'))">
					        	</c:when>
					        	<c:otherwise>
					        		<select style="width:100%; height:381px;" multiple name="right" size="100" ondblclick="delOption(document.getElementById('right'))">
					        	</c:otherwise>
					    </c:choose>
