  ...
  <body>
  	<div class="content">
		...
		<script type="text/javascript">
			...
			tree.loadXML("${ctx}/common/depuserTree.action?id=0&isSelectType=<%=isSelectType%>&rearchUserOrDep=<%=URLEncoder.encode(URLEncoder.encode(rearchUserOrDep.equals("快速查找......")?"":rearchUserOrDep,"UTF-8"),"utf-8")%>");
		...
		*/
		...
		function insertOneData(id)
		{
			if(id!=''){
				...
				var parentText = tree.getItemText(parentId);//获取父节点text
				$("#inertData").append("<div id=" + id+" idText="+text+"><b>" + text+"</b> ["+type+"]"+"；<img src=\"../style/blue/images/del_user.jpg\" onclick='delItem(\""+id+"\")' style=\"margin-left:2px; margin-bottom:-1px;\" alt=\"删除\"></img></div>");
			}
		}
