...
<html>
	...
	<table cellpadding="0" cellspacing="5" class="layout_table" style="width:100%" >
	 ...
	 <div class="left_no1">
	     <iframe  name="personal_information" src="personal_information.jsp" width="100%" height="230"  scrolling="no" frameborder="0" >
	     </iframe>
	</div>
	...
	<div class="left_no3">
	      <iframe  name="order_draft" src="base_draft_link.jsp" width="100%" height="350" scrolling="no" frameborder="0" >
	     </iframe>
	</div>
	...
	<td>
	  <div class="center_no1">
	     <iframe  name="wait_order" src="wait_order.jsp" width="100%" height="230" scrolling="no" frameborder="0" >
	     </iframe>
	</div> 
	
	 <div class="center_no2">
	     <iframe  name="board" src="board.jsp" width="100%" height="230" scrolling="no" frameborder="0" >
	     </iframe>
	</div> 
	
	  <div class="center_no3">
	     <iframe  name="abortlight" src="abortlight.jsp" width="100%" height="350" scrolling="no" frameborder="0" >
	     </iframe>
	</div> 
	   ...
	   <div class="right_no1">
	     <iframe  name="announcement" src="announcement.jsp" width="100%" height="230" scrolling="no" frameborder="0" >
	      ...
	      <div class="right_no2">
	     <iframe  name="information_topic" src="../../../ultraduty/portal/dutyOrgCurrentCalList.action" width="100%" height="230" scrolling="no" frameborder="0" >
	     </iframe>
	</div> 
	
	    <div class="right_no3">
	     <iframe  name="new_posts" src="link_info.jsp" width="100%" height="350" scrolling="no" frameborder="0" >
	     </iframe>
	</div> 
	    </td>
