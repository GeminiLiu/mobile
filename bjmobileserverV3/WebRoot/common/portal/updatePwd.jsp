	  	...
	  	<div class="content">
		   <div class="title_right">
		      <div class="title_left">
		        <span class="title_bg">
		          <span class="title_icon2"><eoms:lable name='sm_lb_updatePwd' /></span>
		        </span>
		    ...
		    <div class="add_scroll_div_x" id="center">
		    	...
		    	<table style="width:400px">
		    		...
		    		<tr>
		    			...
		    			<td align="left">
		    				<input type="password" name="new_pwd" value="" style="width:200px"/>
		    		...
		    		<tr>
		    			...
		    			<td align="left">
		    				<input type="password" name="new_pwd_repeat" value="" style="width:200px"/>
