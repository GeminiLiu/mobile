...
public class CryptUtils {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length < 2) {
			...
			System.out.println("java com.ultrapower.eoms.common.util.CryptUtils txt mode key");
			System.out.println("txt is required");
			System.out.println("mode is required,1 is encode,2 is decode");
			System.out.println("key is optional,the min length of key is 24 char");
			System.out.println("Example:java com.ultrapower.eoms.common.util.CryptUtils CryptUtils password 1 105269288E76C311410B6595");
