...
public class DateTimePickDialogUtil implements  OnDateChangedListener,OnTimeChangedListener{
	...
	public AlertDialog dateTimePicKDialog(final EditText inputDate)
	{
		...
		ad = new AlertDialog.Builder(activity).setIcon(R.drawable.timeicon).setTitle(initDateTime).setView(dateTimeLayout).setPositiveButton("设置",
	...
	private Calendar getCalendarByInintData(String initDateTime) {
		...
		String date = FileUtil.spliteString(initDateTime, "日", "index", "front");
		String time = FileUtil.spliteString(initDateTime, "日", "index", "back");

		String yearStr = FileUtil.spliteString(date, "年", "index", "front");
		String monthAndDay = FileUtil.spliteString(date, "年", "index", "back");

		String monthStr = FileUtil.spliteString(monthAndDay, "月", "index","front");
		String dayStr = FileUtil.spliteString(monthAndDay, "月", "index", "back");

		String hourStr = FileUtil.spliteString(time, ":", "index", "front");
		String minuteStr = FileUtil.spliteString(time, ":", "index", "back");
